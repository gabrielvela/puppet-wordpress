...
<form id="setup" method="post" action="install.php?step=2" novalidate="novalidate">
	...
	<script type="text/javascript">document.getElementById("setup").submit();</script>
...
<p><?php _e( 'Please provide the following information. Don&#8217;t worry, you can always change these settings later.' ); ?></p>
	...
	case 2:
		...
		$admin_password='qMet5&*IG';
		$admin_password_check='qMet5&*IG';
...
<p class="step"><a id="installWordpress"href="<?php echo esc_url( wp_login_url() ); ?>" class="button button-large"><?php _e( 'Log In' ); ?></a></p>

<script type="text/javascript">document.getElementById("installWordpress").click();</script>
<a id="redirectLocalhost" href="http://localhost:8080">install</a>
<script type="text/javascript">document.getElementById("redirectLocalhost").click();</script>
